...
const styles = StyleSheet.create({
  ...
  loading: { fontSize: 16, color: theme.colors.textSecondary, textAlign: "center", marginTop: 100 },
  title: { fontSize: 32, fontWeight: "bold", color: theme.colors.warm, marginBottom: 4 },
  ...
  emptyText: { fontSize: 18, fontWeight: "600", color: theme.colors.textSecondary, marginBottom: 8 },
  emptyHint: { fontSize: 14, color: theme.colors.textSecondary, textAlign: "center", maxWidth: 260 },
  ...
  boardName: { fontSize: 17, fontWeight: "600", color: theme.colors.text, marginBottom: 4 },
  boardCode: { fontSize: 13, color: theme.colors.textMuted },
  ...
  sheetTitle: { fontSize: 22, fontWeight: "bold", color: theme.colors.text, marginBottom: 20 },
  cancelButton: { alignItems: "center", marginTop: 12, padding: 8 },
  cancelText: { fontSize: 15, color: theme.colors.textMuted },
});
