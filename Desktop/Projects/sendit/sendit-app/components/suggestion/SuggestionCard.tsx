...
const styles = StyleSheet.create({
  ...
  label: { fontSize: 11, fontWeight: "700", color: theme.colors.primary, letterSpacing: 1.5 },
  emoji: { fontSize: 24 },
  what: { fontSize: 22, fontWeight: "bold", color: theme.colors.text, marginBottom: 16, lineHeight: 28 },
  details: { gap: 10, marginBottom: 16 },
  detailRow: { flexDirection: "row", alignItems: "center", gap: 10 },
  detailIcon: { fontSize: 16 },
  detailText: { fontSize: 15, color: theme.colors.textSecondary, flex: 1 },
  whyToggle: { paddingVertical: 8 },
  whyToggleText: { fontSize: 14, color: theme.colors.primary, fontWeight: "600" },
  whyBox: { backgroundColor: theme.colors.bgCardLight, borderRadius: 10, padding: 14, marginBottom: 16 },
  whyText: { fontSize: 14, color: theme.colors.textSecondary, lineHeight: 20 },
  influencedBy: { fontSize: 12, color: theme.colors.textMuted, marginTop: 8, fontStyle: "italic" },
  ...
  emptyHint: { fontSize: 14, color: theme.colors.textSecondary, textAlign: "center" },
  errorText: { fontSize: 12, color: theme.colors.warm, marginTop: 12, textAlign: "center" },
});
