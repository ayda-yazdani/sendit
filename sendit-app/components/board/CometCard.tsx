...
const styles = StyleSheet.create({
  ...
  statValue: { fontSize: 16, fontWeight: "bold", color: theme.colors.text, fontFamily: theme.fonts.bold },
  statLabel: { fontSize: 10, color: theme.colors.textMuted, fontFamily: theme.fonts.regular },
  ...
  tagText: { fontSize: 13, color: theme.colors.warm, fontWeight: "500", fontFamily: theme.fonts.semibold },
  aesthetic: {
    fontSize: 16,
  ...
  metaItem: { fontSize: 13, color: theme.colors.textSecondary, fontFamily: theme.fonts.regular },
  humour: { fontSize: 13, color: theme.colors.textSecondary, fontFamily: theme.fonts.regular },
  platformRow: {
    flexDirection: "row",
    gap: 12,
    marginBottom: 16,
  ...
  platformCount: { fontSize: 12, fontWeight: "700", color: theme.colors.text, fontFamily: theme.fonts.bold },
  branding: {
    fontSize: 11,
